...
class ItemDetailsElegantPage extends StatefulWidget {
  ...
  const ItemDetailsElegantPage({super.key, required this.item});

  @override
  State<ItemDetailsElegantPage> createState() => _ItemDetailsElegantPageState();
}

class _ItemDetailsElegantPageState extends State<ItemDetailsElegantPage> {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      if (item.assetHash != null && item.assetHash!.isNotEmpty)
                        _buildDetailRow('Asset hash', item.assetHash!),
                      _buildDetailRow('Listed', item.isListed ? 'Yes' : 'No'),
